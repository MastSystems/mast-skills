...
> themselves (C1) are generated by the binary, which is their sole source of
> truth — skills must never restate or paraphrase them; this section states the
> rule the messages enforce.
